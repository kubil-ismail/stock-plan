        ...
        <form onSubmit={handleSubmit}>
              ...
              <div>
                ...
                {!broker && (
                  <div className="mt-2 flex items-start gap-2 text-muted-foreground text-[12px]">
                    ...
                    <p>Tambahkan sekuritas di Profile jika belum tersedia</p>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="mt-4 p-3 rounded-lg bg-accent/50">
                  <p className="text-[13px] text-foreground text-center">
                    <span className="font-semibold">{orderType}</span> {lot} lot{" "}
                    {selectedStock.code} @ ${targetPrice} via{" "}
          ...
          <div className="flex gap-3">
            <Button
              ...
              className="flex-1"
              disabled={
                !broker || !lot || !targetPrice || !executionTime || !expiryDate
              }
            >
              Create Order
            </Button>
