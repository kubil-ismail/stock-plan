...
export default function IdeasDetail() {
  ...
  const setup = mockSetups.find((s) => s.id === slug);
            ...
            <div className="space-y-3">
              {setup.rules.map((rule, index) => (
                ...
                >
                  ...
                  <p className="text-[14px] text-foreground flex-1">{rule}</p>
                </div>
              ))}
            </div>
          </GlassCard>
          ...
          <GlassCard className="p-6">
            ...
            <div className="prose prose-sm max-w-none">
              <p className="text-[14px] text-muted-foreground leading-relaxed">
                This setup is designed to identify high-probability trading
                opportunities based on technical analysis and market structure.
                Always use proper risk management and position sizing when
                implementing any trading strategy.
              </p>
              <p className="text-[14px] text-muted-foreground leading-relaxed mt-4">
                Remember to backtest this strategy with your own parameters and
                adjust the rules based on your risk tolerance and trading style.
