...
const mockNotifications = [
  {
    ...
    description:
      "Your buy order for BBCA (100 shares) has been filled at Rp 8,750",
    date: "2026-02-27",
    time: "2 hours ago",
    isRead: false,
    icon: DollarSign,
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
            <h1 className="text-[24px] md:text-[32px] font-bold text-foreground">
              Notifications
            </h1>
            {unreadCount > 0 && (
            ...
            return (
              ...
              >
                <div className="flex items-start gap-4">
                  {/* Icon */}
                  <div
                    className={`w-12 h-12 rounded-xl ${notification.bgColor} flex items-center justify-center flex-shrink-0`}
                  >
        ...
        <GlassCard className="p-12">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="text-[14px] text-muted-foreground max-w-sm mb-6">
              ...
              found. Check back later for updates.
            </p>
            <button
